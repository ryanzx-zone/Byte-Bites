...
import { View, Text, Button, StyleSheet, Dimensions, SafeAreaView, Platform, StatusBar, Vibration, Alert } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    position: 'absolute',
    bottom: Platform.OS === 'android' ? (StatusBar.currentHeight || 0) + 16 : 16,
    left: 0,
    right: 0,
    flexDirection: 'row',
